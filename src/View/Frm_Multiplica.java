...
import Classes.Cls_Multiplica;

public class Frm_Multiplica extends javax.swing.JFrame {


    public Frm_Multiplica() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        txtValorA.setFont(new java.awt.Font("Arial", 0, 36)); // NOI18N

        txtValorB.setFont(new java.awt.Font("Arial", 0, 36)); // NOI18N
    ...
    private void btnCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcularActionPerformed
        ...
        ValorA = Integer.parseInt(this.txtValorA.getText());
        ValorB = Integer.parseInt(this.txtValorB.getText());
        //3.Instanciar a classe Cls_Multiplica
        Cls_Multiplica Obj_Multiplica = new Cls_Multiplica();
        //4.Utilizar o  objeto Obj_Multiplica
        valorFinal=Obj_Multiplica.multiplicar(ValorA, ValorB);
        //5.Exibir o valor total
        this.txtResultado.setText(valorFinal.toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frm_Multiplica.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Frm_Multiplica().setVisible(true);
            }
        });
    }
